...
const (
	ShortenerService_CreateURLShorten_FullMethodName = "/shortener.ShortenerService/CreateURLShorten"
...
type ShortenerServiceClient interface {
	CreateURLShorten(ctx context.Context, in *CreateURLShortenRequest, opts ...grpc.CallOption) (*CreateURLShortenResponse, error)
...
func (c *shortenerServiceClient) CreateURLShorten(ctx context.Context, in *CreateURLShortenRequest, opts ...grpc.CallOption) (*CreateURLShortenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateURLShortenResponse)
	err := c.cc.Invoke(ctx, ShortenerService_CreateURLShorten_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shortenerServiceClient) ListUserURLs(ctx context.Context, in *ListUserURLsRequest, opts ...grpc.CallOption) (*ListUserURLsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ShortenerServiceServer interface {
	CreateURLShorten(context.Context, *CreateURLShortenRequest) (*CreateURLShortenResponse, error)
...
func (UnimplementedShortenerServiceServer) CreateURLShorten(context.Context, *CreateURLShortenRequest) (*CreateURLShortenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateURLShorten not implemented")
}
...
func (UnimplementedShortenerServiceServer) ListUserURLs(context.Context, *ListUserURLsRequest) (*ListUserURLsResponse, error) {
...
func _ShortenerService_CreateURLShorten_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateURLShortenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShortenerServiceServer).CreateURLShorten(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShortenerService_CreateURLShorten_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortenerServiceServer).CreateURLShorten(ctx, req.(*CreateURLShortenRequest))
	}
...
var ShortenerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateURLShorten",
			Handler:    _ShortenerService_CreateURLShorten_Handler,
		},
		{
	...
	Metadata: "v1/proto/shortener_service.proto",
}
